...
labels = np.loadtxt(os.path.join(abs_path, 'model_shape/synset.txt'), str, delimiter='\t')
gpu_id = 0
...
def initial():
    ...
    deploy_path = os.path.join(abs_path, 'model_shape/test.prototxt')
    model_path = os.path.join(abs_path, 'model_shape/mobile.caffemodel')
    mean_path = os.path.join(abs_path, 'model_shape/train_mean.npy')
